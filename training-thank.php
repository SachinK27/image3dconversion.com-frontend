...
<html dir="ltr" lang="en">
  <head>
    ...
    <!-- Page Title -->
    <title>Training Thank You</title>
  ...
  <body class="has-side-panel side-panel-right fullwidth-page side-push-panel">
    ...
    <div id="side-panel" class="dark" data-bg-img="images/bg/bg8.jpg">
      <div class="side-panel-wrap">
        ...
        <a href="javascript:void(0)">
          <img alt="logo" data-src="images/logo-wide.png">
        </a>
    ...
    <div id="wrapper" class="clearfix">
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-12 text-center">
                <br>
                <br>
                <h3 class="title">Thank You for registering in our 3 days workshop.</h3>
                <p>We will get back to you soon with the venue details and payment process. <br>
                  <b> For any enquires you can call us or whatsapp us at 8876395581</b>
                </p>
                <br>
              </div>
            </div>
      ...
      <!-- end main-content --> <?php include 'footer1.php'; ?>
      <!-- Footer -->
